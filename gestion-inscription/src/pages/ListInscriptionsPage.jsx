               ...
               <div className="row g-3">
                  ...
                  <div className="col-md-1">
                     <button
                        ...
                        onClick={() => {}} // Le filtrage se fait automatiquement via les états
                     >
                  ...
                  <table className="table table-hover table-sm">
                     <thead>
                        <tr>
                           ...
                           <th>Candidat</th>
                           <th>Concours</th>
                           <th className="text-nowrap">Date Inscription</th>
                           <th>Statut</th>
                           <th>Actions</th>
                        </tr>
                     </thead>
                           ...
                           inscriptions.map((inscription) => {
                              ...
                              return (
                                 <tr key={inscription.id}>
                                    ...
                                    <td>{inscription.concours_mention}</td>
                                    <td>
                                       {new Date(
                        ...
                        <div className="modal-body">
                           ...
                           <div className="mb-3">
                              ...
                              <input
                                 type="text"
                                 className="form-control"
                                 value={selectedInscription.concours_mention}
                                 disabled
                              />
                           </div>
                           ...
                           <div className="mb-3">
                              ...
                              <select
                                 ...
                                 id="modal-statut"
                                 name="statut"
                                 defaultValue={selectedInscription.statut}
                              >
