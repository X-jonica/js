      ...
      <div className="inscription-container">
         <section className="welcome-section">
            <div className="welcome-content">
               ...
               <p>
                  Rejoignez l'élite académique et donnez une nouvelle dimension
                  à votre parcours éducatif. Notre institution, reconnue pour
                  son excellence, ouvre ses portes aux esprits les plus
                  brillants.
               </p>
               <p>
                  Que vous soyez en Droit, Economie ou Multimédia, nous avons
                  conçu des programmes d'études qui répondent aux exigences du
                  monde contemporain.
               </p>
               <div className="deadline-box">
                  <i className="bi bi-calendar-check"></i>
                  <span>Date limite : 25 octobre 2025</span>
               </div>
            </div>
         </section>
               ...
               <div className="form-card">
                  <div className="form-header">
                     <h1 className="form-title">
                        <i className="bi bi-pencil-square"></i> Formulaire
                        d'inscription
                     </h1>
                  ...
                  <form onSubmit={handleSubmit}>
                     <div className="form-grid">
                        ...
                        <div className="form-group floating">
                           <input
                              ...
                              placeholder=" "
                           />
                           <label htmlFor="annee_bacc">Année du Bac *</label>
                           <div className="invalid-feedback">
                              Année invalide
                           </div>
                        </div>
                        ...
                        <div className="form-group floating">
                           ...
                           >
                              <option value=""></option>
                              {(Array.isArray(concours) ? concours : []).map(
                                 (c) => (
                     ...
                     >
                        {isLoading ? (
                           <>
                              <i className="bi bi-arrow-repeat"></i> En cours...
                           </>
                        ) : (
                           <>
